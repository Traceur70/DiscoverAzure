(function () {
    ...
    function refreshViewData() {
        ...
        authContext.acquireToken(authContext.config.clientId, function (error, token) {
            ...
            $.ajax({
                type: "GET",
                url: window.config.serviceHostUrl + "/api/TodoList/GetUser",
                dataType: 'jsonp',
                headers: {
    ...
    function registerDataClickHandlers() {
        ...
        $(".view-data-delete").click(function (event) {
            ...
            authContext.acquireToken(authContext.config.clientId, function (error, token) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: window.config.serviceHostUrl + "/api/TodoList/" + todoId,
                    headers: {
                        'Authorization': 'Bearer ' + token,
                    },
                }).done(function () {
        ...
        $(".view-data-save").click(function (event) {
            ...
            authContext.acquireToken(authContext.config.clientId, function (error, token) {
                ...
                $.ajax({
                    type: "PUT",
                    url: window.config.serviceHostUrl + "/api/TodoList",
                    headers: {
                        'Authorization': 'Bearer ' + token,
                    },
                    data: {
